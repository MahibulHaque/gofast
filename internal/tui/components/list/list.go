...
// NewSingleSelectFromStep creates a single-select list from a step
...
// ToMultiInputSelection converts Selection to multiInput.Selection format for compatibility
func (s *Selection) ToMultiInputSelection() interface{} {
	return struct {
		Choice string
	}{
		Choice: s.Choice,
